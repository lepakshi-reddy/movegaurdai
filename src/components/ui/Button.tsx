...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary:
      'bg-white hover:bg-slate-200 text-black shadow-glow-cyan shadow-sm active:scale-[0.98]',
    secondary:
      'bg-white/10 hover:bg-white/15 text-white border border-white/15 active:scale-[0.98]',
    outline:
      'bg-transparent hover:bg-white/10 text-white border border-white/30 hover:border-white active:scale-[0.98]',
    danger:
